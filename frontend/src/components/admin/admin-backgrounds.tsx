    ...
    <div>
      <form onSubmit={(event) => void upload(event)} className="glass-panel rounded-3xl p-6">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3">
            ...
            {(["basic", "full"] as const).map((value) => (
              <button
                ...
                className={
                  ...
                  (tier === value ? "bg-gold text-[#171614]" : "text-white/65 hover:text-white")
                }
              >
                {TIER_LABEL[value]}
              </button>
          ...
          <button
            type="submit"
            disabled={!file || busy}
            className="press bg-gold ml-auto flex min-h-10 items-center gap-2 rounded-full px-6 text-sm font-medium text-black disabled:opacity-40"
          >
      ...
      <div className="mt-8 flex items-center gap-3">
        ...
        <button
          ...
          className="press on-dark-muted ml-auto flex min-h-9 items-center gap-1.5 rounded-full px-4 text-xs ring-1 ring-white/15 hover:text-white"
        >
      ...
      {state.status === "loading" ? (
        ...
        <ul className="soft-fade mt-4 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
          {items.map((item) => (
            <li key={item.id} className="glass-panel overflow-hidden rounded-2xl">
              ...
              <div className="space-y-2 px-3 py-2.5">
                  ...
                  {(["basic", "full"] as const).map((value) => (
                    <button
                      ...
                      className={
                        ...
                        (item.tier === value ? "bg-gold text-[#171614]" : "text-white/60 hover:text-white")
                      }
                    >
                      {TIER_LABEL[value]}
                    </button>
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="press on-dark-muted min-h-8 flex-1 rounded-full text-[0.6875rem] ring-1 ring-white/15 hover:text-white disabled:opacity-40"
                  >
                  ...
                  {confirmId === item.id ? (
                    <>
                      <button
                        ...
                        className="press min-h-8 shrink-0 rounded-full bg-red-500/20 px-3 text-[0.6875rem] text-red-200 disabled:opacity-40"
                      >
                        Sil
                      </button>
                      <button
                        ...
                        className="press on-dark-muted min-h-8 shrink-0 rounded-full px-2 text-[0.6875rem] hover:text-white"
                      >
                        Vazgeç
                      </button>
                    </>
                    ...
                    <button
                      ...
                      className="press on-dark-muted flex size-8 shrink-0 items-center justify-center rounded-full ring-1 ring-white/15 hover:text-red-200 disabled:opacity-40"
                    >
